...
const users = [
  ...
  {name: "Emily T.", PFP: PFP2, rating: 10, review: "Great service and a relaxed vibe. Indoor seating was quiet and comfortable."},
  {name: "Daniel R.", PFP: PFP3, rating: 9, review: "Perfect spot for date night. Cozy atmosphere and everything we ordered was delicious."},
